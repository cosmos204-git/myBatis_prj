...
/**
 * insert에 추가되는 값, update의 변경값, where절 사용하는 값, delete의 where절에서 사용하는 값
 * select where절 사용하는 값
 * 
 * <jsp:useBean> : 기본생성자를 사용하여 객체화를 하고 
 * <jsp:setProperty> : setter method를 통해 입력값이 저장
 * MyBatis 에서는 parameterType="EmpDTO" 입력 받아서 #{ getter명 } 으로 사용
 * 
 */
public class EmpDTO {
	...
	public void setDeptno(int deptno) {
		System.out.println("<jsp:setProperty 에서 setDeptno 로 사용");
		this.deptno = deptno;
	}
	...
	public void setEmpno(int empno) {
		System.out.println("<jsp:setProperty 에서 setEmpno 로 사용");
		this.empno = empno;
	}
