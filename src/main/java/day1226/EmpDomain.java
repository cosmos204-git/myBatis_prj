...
public class EmpDomain {
	...
	public void setEname(String ename) {
		System.out.println("MyBatis 에서 조회 결과가 있을 때 setEname 사용 ");
		this.ename = ename;
	}
	...
	public void setSal(int sal) {
		System.out.println("MyBatis 에서 조회 결과가 있을 때 setSal 사용 ");
		this.sal = sal;
	}
	...
	public void setComm(int comm) {
		System.out.println("MyBatis 에서 조회 결과가 있을 때 setComm 사용 ");
		this.comm = comm;
	}
	...
	public void setHiredate(Date hiredate) {
		System.out.println("MyBatis 에서 조회 결과가 있을 때 setHiredate 사용 ");
